    ...
    try {
        ...
        switch (errorCode) {
            case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
                imageName = window.path+"/images/error.gif";
                break;
...
function addImage(src){
    var newElement = "<li><img class='content'  src='" + src + "' style=\"width:100px;height:100px;\"><img class='button' src="+window.path+"/images/fancy_close.png><input type='hidden' name='uploadPic[]' value=" + src + "/></li>";
...
//    var fid = $(this).parent().prevAll().length + 1;
    ...
    $.ajax({
        ...
        url: window.url+"/upload/del", //调用WebService的地址和方法名称组合---WsURL/方法名
        data: "src=" + src,
