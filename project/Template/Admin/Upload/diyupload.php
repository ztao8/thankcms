...
<link rel="stylesheet" type="text/css" href="__PUBLIC__/plugin/diyUpload/css/webuploader.css">
<link rel="stylesheet" type="text/css" href="__PUBLIC__/plugin/diyUpload/css/diyUpload.css">
<script type="text/javascript" src="__PUBLIC__/plugin/diyUpload/js/webuploader.html5only.min.js"></script>
<script type="text/javascript" src="__PUBLIC__/plugin/diyUpload/js/diyUpload.js"></script>
</head>
<style>
*{ margin:0; padding:0;}
...
<div id="floor">
	<button id="ok" onclick="{$callback}()" class="btn btn_c" type="button">确认完成</button>
...
$('#pic').diyUpload({
	url:"{:C('SITE_MANAGE_URL')}/upload/upload",
