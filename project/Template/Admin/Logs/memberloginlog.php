...
<div class="wrap J_check_wrap"> 
   	<ul class="nav nav-tabs">
		<li class="active"><a href="{:U('logs/memberLoginlog')}">登陆日志</a></li>
		<li><a href="{:U('logs/deleteMemberLoginlog')}">删除一个月前登陆日志</a></li>
	</ul>
	<form action="{:U('logs/memberLoginlog')}" method="get" class="well form-search">
